...
export async function update( id, title, keyword, detail, timestamp,snedcode) {
  return DataList.findByIdAndUpdate(id, {title, keyword, detail, timestamp,snedcode}, 
